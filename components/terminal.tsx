...
const Terminal = () => {
  ...
  return (
    <div className="bg-zinc-900 text-green-500 p-4 font-mono flex flex-col w-full h-full">
      <div ref={outputRef} className="grow overflow-y-auto mb-2 scrollbar-thin scrollbar-thumb-green-900 scrollbar-track-zinc-800">
      ...
      <div className="flex items-center border-t border-zinc-700 pt-2">
        ...
        <div className="flex grow relative">
          <input
            ...
            className="bg-transparent outline-none grow ml-1 text-green-300 w-full"
            spellCheck={false}
            autoComplete="off"
            autoCapitalize="off"
